...
impl Key {
    pub fn translate(self, lang: &Language) -> &'static str {
        match (self, lang) {
            ...
            (Key::StatusNotStarted, &Language::Zh) => "未启动",
            (Key::StatusNotStarted, &Language::En) => "Not Started",
            ...
            (Key::LabelGpuLayers, &Language::Zh) => "GPU 层数 (n-gpu-layers):",
            (Key::LabelGpuLayers, &Language::En) => "GPU Layers (n-gpu-layers):",
            ...
            (Key::FileExists, &Language::Zh) => "文件存在",
            (Key::FileExists, &Language::En) => "File exists",
            (Key::FileNotExists, &Language::Zh) => "文件不存在",
            (Key::FileNotExists, &Language::En) => "File not found",
