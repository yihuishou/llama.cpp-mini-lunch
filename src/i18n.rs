...
(Key::DialogSelectRpc, &Language::En) => "Select rpc-server executable",
        ...
        // 模型面板
            ...
            (Key::BtnSelectFolder, &Language::Zh) => "选择文件夹",
            (Key::BtnSelectFolder, &Language::En) => "Select Folder",
            (Key::DialogSelectFolder, &Language::Zh) => "选择模型文件夹",
            (Key::DialogSelectFolder, &Language::En) => "Select model folder",
            (Key::NoModelDir, &Language::Zh) => "尚未选择文件夹",
            (Key::NoModelDir, &Language::En) => "No folder selected",
